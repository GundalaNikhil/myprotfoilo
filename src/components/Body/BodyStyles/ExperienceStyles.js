...
export const useStyles = makeStyles(() => ({
  button: {
    ...
    "&:hover:after": {
      boxShadow: "0px 0px 56px 12px #ffffffa6",
    },
    "&::before": {
      content: '""',
      position: "absolute",
